                    ...
                    children: <Widget>[
                      Container(
                        decoration: BoxDecoration(
                          ...
                          //if isEligible is false then set red color else if it is true then set green
                      ...
                      Container(
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            ...
                            if (age < 150)
                              Provider.of<EligiblityScreenProvider>(context,
                                      listen: false)
                                  .checkEligiblity(
                                      age); // or provider.checkEligiblity(age);
                          },
                        ),
                      ),
                      SizedBox(
